  ...
  return (
    <section className="py-20 md:py-28 bg-white text-slate-900 relative overflow-hidden border-b border-slate-200">
      <Container className="relative z-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {painPointsData.items.map((item) => {
            ...
            return (
              <div 
                key={item.id}
                className="group relative bg-slate-50 border border-slate-200/90 hover:border-rose-400 p-6 rounded-2xl transition-all duration-300 hover:shadow-xl hover:shadow-slate-200 flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex items-start gap-3.5 mb-3">
                    <div className="p-2.5 rounded-xl bg-white border border-slate-200 text-rose-600 group-hover:bg-rose-50 group-hover:border-rose-200 transition flex-shrink-0 shadow-sm">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
          ...
          {solutionsList.map((item) => {
            ...
            return (
              <div
                ...
                className={`group relative rounded-2xl overflow-hidden border cursor-pointer transition-all duration-300 flex flex-col justify-between h-60 shadow-md ${
                  isActive
                    ? 'border-[#EA9512] ring-2 ring-[#EA9512]/50 shadow-xl'
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4 space-y-4 bg-slate-900/60 p-6 rounded-2xl border border-slate-800">
            ...
            <div className="border-t border-slate-800 pt-3 space-y-2">
              <h4 className="text-sm font-bold text-white flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-[#06C755]" /> LINE 官方帳號
              </h4>
              ...
              <div className="pt-1">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#06C755] hover:bg-[#05b34c] text-white font-bold px-4 py-2 rounded-lg transition text-xs shadow-md"
                >
                  立即加入 LINE 諮詢 <ArrowRight className="w-3.5 h-3.5" />
                </a>
              </div>
            </div>
          </div>
