        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="pt-6 border-t border-slate-700/60 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
            {heroData.trustBadges.map((badge, idx) => {
              ...
              return (
                <div key={idx} className="flex items-center gap-2 bg-slate-900/90 p-2.5 rounded-lg border border-slate-800 text-slate-200 shadow-md backdrop-blur">
            ...
            <div className="lg:col-span-5 bg-slate-900 text-white border border-slate-800 rounded-2xl p-6 sm:p-8 space-y-6 flex flex-col justify-between shadow-xl">
              ...
              <div className="pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] font-mono text-slate-400">
                <span className="flex items-center gap-1.5">
                  <Building2 className="w-3.5 h-3.5 text-[#EA9512]" /> 總公司
                </span>
